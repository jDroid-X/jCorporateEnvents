...
const StoriesManager = {
    ...
    renderMenu(mountPoint) {
        ...
        this.stories.forEach(s => {
            ...
            row.style.cssText = "padding:10px 14px; font-size: 0.85rem; color: var(--text, #fff); border-bottom:1px solid rgba(255,255,255,0.05); cursor:pointer; opacity: 0.85; transition: opacity 0.2s;";
