...
<body class="single-page-body">
    ...
    <nav class="navbar">
        <div class="container">
            <a href="{root}index.html" class="logo"><img src="{root}images/logo.png" alt="TacTiq" style="height:60px; max-height:60px; width:auto; vertical-align:middle;"></a>
            ...
            <div class="nav-links">
                <div class="nav-item dropdown">
                    <a href="{root}index.html" class="dropdown-trigger">Home <span class="chevron">▾</span></a>
                    <div class="dropdown-menu" style="min-width: 200px; width: 220px; padding: 25px;">
                        <ul class="dropdown-list">
                            <li><a href="{root}index.html">Overview</a></li>
                            <li><a href="{root}index.html#narrative">Vision</a></li>
                            <li><a href="{root}index.html#speakers">Speakers</a></li>
                            <li><a href="{root}index.html#agenda">Agenda</a></li>
                        </ul>
                    </div>
                </div>
                <div class="nav-item dropdown">
    ...
    <!-- Demo Disclaimer -->
    <div class="demo-disclaimer" style="position: fixed; bottom: 8px; left: 50%; transform: translateX(-50%); font-size: 0.7rem; opacity: 0.6; z-index: 3000; text-transform: uppercase; white-space: nowrap; color: var(--text-primary);">
...
pages = [
    ...
    },
    {
        ...
        "image_path": "images/event-solutions/home-services.jpg",
    ...
    },
    {
        ...
        "image_path": "images/our-work/site-selection.jpg",
    ...
    },
    {
        ...
        "image_path": "images/our-work/franchise-hosp.jpg",
    ...
    },
    {
        ...
        "image_path": "images/resources/conf-costs.jpg",
    ...
    },
    {
        ...
        "image_path": "images/resources/incentive-costs.jpg",
    ...
    },
    {
        ...
        "image_path": "images/resources/site-visit.jpg",
    ...
    },
    {
        ...
        "image_path": "images/resources/top-conf-dest.jpg",
    ...
    },
    {
        ...
        "image_path": "images/resources/top-incentive-dest.jpg",
